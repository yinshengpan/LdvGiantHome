...
//static byte product_data_crc8(byte[] dat)
//        {
//        byte Polynom = 0x8C;
//        byte CrcCalc = 0xFF;
//        byte ByteNum, BitNum;
//        bool Flag = false;
//
//        for (ByteNum = 0; ByteNum < dat.Length; ByteNum++)
//        {
//        CrcCalc ^= dat[ByteNum];
...
//        Flag = true;
//        CrcCalc >>= 1;
//        if (Flag) CrcCalc ^= Polynom;
//        }
//        }
//        return CrcCalc;
//        }
public class ProductDataCrc8 {
    ...
    public static byte perform(byte[] dat, int length)
{
//    byte Polynom = (byte) 0x8C;
//    byte CrcCalc = (byte) 0xFF;
    long crc = 0xFF;
...
//    return CrcCalc;
    ...
    public static byte tryCrc8(byte[] data)
    {
