...
import com.ledvance.light.screen.scenes.ScenesScreen
...
internal fun SnapshotStateList<Any>.navigateToScenes(deviceId: DeviceId) {
    add(ScenesRoute(deviceId))
}

internal fun EntryProviderScope<Any>.scenesScreen(
    onBackClick: () -> Unit
) {
    entry<ScenesRoute> {
